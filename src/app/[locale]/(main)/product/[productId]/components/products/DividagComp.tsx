					...
					<div className="">
						...
						<div className="model-usage p-3 sm:p-4 grid grid-cols-1 max-w-2xl mx-auto">
							...
							{thisProd.modelSizes.length > 0 && (
								<div className="model-sizes p-3 sm:p-4 flex items-center">
						...
						<div className="w-full flex justify-center flex-col items-center gap-8 mt-12">
							...
							<div className="relative">
								<EnlargeableImage
									...
									className={`py-6 ${isRTL ? "" : ""}`}
								/>
								<span className="absolute -right-2 -bottom-5 bg-appTextBlue px-2 py-2 text-white m-1">
									{thisProd.modelExtraContent.extraContent2}
								</span>
								<span className="absolute right-1/2 -translate-x-1/2 -bottom-5 bg-appTextBlue px-2 py-2 text-white m-1">
