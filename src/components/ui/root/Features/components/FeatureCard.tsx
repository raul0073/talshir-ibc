...
function FeatureCard({
  ...
  return (
    <div className="group relative rounded-[.2rem]  p-8 overflow-hidden transition duration-300 bg-gradient-to-tl from-[#2455CF] to-[#7198FD]">
      {/* Background effects */}
      <div className="pointer-events-none">
        <div className="absolute inset-0 rounded-[.2rem] transition duration-300 [mask-image:linear-gradient(white,transparent)] group-hover:opacity-50">
          <svg
            aria-hidden="true"
        ...
        <div className="absolute inset-0 rounded-[.2rem] bg-gradient-to-r from-[#b7c976] to-appBlue opacity-0 transition duration-300 group-hover:opacity-100"
