		...
		<div className="w-full h-full relative">
			...
			<div className="relative w-2/3 mx-auto flex justify-start items-start gap-4 mt-24 sm:mt-0 ">
				<motion.div
					...
					viewport={{ once: true }}
					className={`relative md:-top-24 lg:-top-36 lg:-right-12 `}>
					<Image
						src={logo}
						alt="talshir-ibc logo 300X300"
						width={300}
						height={300}
						className=" z-10 relative hover:-translate-y-2 transition-transform duration-200 ease-in-out saturate-200 w-36 sm:w-48 h-auto"
					/>
				</motion.div>
			</div>
