...
**תאריך תחולה:** 25/05/2025  

**1. מבוא**  
ברוכים הבאים לטלשיר IBC.  
...
למימוש זכויותיכם, אנא צרו קשר בכתובת itamarweiss@talshir-ibc.com.  
...
**1. הקדמה**  
ברוכים הבאים לאתר טלשיר IBC. השימוש באתר כפוף לתנאים והגבלות אלה, וכל שימוש באתר מהווה הסכמה לתנאים אלו.  
...
- כל התכנים, לרבות טקסטים, תמונות, לוגואים, עיצובים ותכנים אחרים, הם רכושו של טלשיר IBC ומוגנים על פי חוקי הקניין הרוחני.  
...
**6. יצירת קשר**  
לכל שאלה או בירור, ניתן לפנות אלינו בכתובת itamarweiss@talshir-ibc.com.  
`;
...
אם נתקלתם בקושי בגלישה באתר או שיש לכם הצעות לשיפור הנגישות, נשמח לשמוע מכם בכתובת itamarweiss@talshir-ibc.com.  
