...
export default function StatsBar() {
  ...
  const memoStatsData = useMemo(
    () => [
      { id: "patents-counter", title: content.raw("patents"), value: 9, icon: patent },
      { id: "clients-counter", title: content.raw("clients"), value: 672, icon: clients },
      { id: "products-counter", title: content.raw("products"), value: 26, icon: products },
      { id: "countries-counter", title: content.raw("countries"), value: 3, icon: world },
    ],
    [content]
  );
